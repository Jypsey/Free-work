...
BOT_TOKEN = '6236356662:AAHtNHhv1U2SK4yh5VGY20AoaZ9Zb_L0rrs'
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gandhijidatabase:gandhijidatabase@cluster0.pycczqg.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# FSUB
auth_channel = environ.get('AUTH_CHANNEL', '-1001676067733')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1001676067733')
